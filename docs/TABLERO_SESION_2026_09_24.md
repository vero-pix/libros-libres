...
- ✅ 25-09 — **Foto en grande en la ficha** (pedido de Vero): tocar la foto (o la lupa) la abre a pantalla completa, sin el recorte del "libro" dibujado; en escritorio un clic amplía al doble donde apuntas, en el celular sirve el zoom con los dedos; se cambia de foto con flechas o teclado y se cierra con Esc o la X. Probado en local en escritorio y iPhone (5/5).

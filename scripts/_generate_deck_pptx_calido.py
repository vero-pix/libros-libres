...
# Paleta CÁLIDA — ninguna slide con fondo oscuro
...
INK = RGBColor(0x2d, 0x2e, 0x3d)         # tinta suave, no negro puro
MUTED = RGBColor(0x8b, 0x8b, 0x9c)
WHITE = RGBColor(0xff, 0xff, 0xff)
DEEP_BLUE = RGBColor(0x3d, 0x46, 0x70)   # azul suave para títulos donde antes iba navy
...
# Guardar
output = '/Users/veronicavelasquez/libros-libres/docs/deck_valorizacion_calido.pptx'
prs.save(output)
print(f"✓ Generado: {output}")
print(f"  {len(prs.slides)} slides, paleta CÁLIDA (sin fondos oscuros — para audiencia familiar)")

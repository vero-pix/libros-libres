...
export function correoResena(d: DatosCorreoResena): { subject: string; html: string } {
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#1a1a1a;line-height:1.5">
      ...
      <p style="margin:20px 0"><a href="${ficha}#resena-vendedor" style="display:inline-block;background:#1a1a1a;color:#fbf7ef;text-decoration:none;padding:11px 18px;border-radius:8px;font-weight:600">Contar cómo me fue con ${esc(vendedor)}</a></p>

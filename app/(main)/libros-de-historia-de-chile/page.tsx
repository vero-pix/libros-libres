...
const faqs = [
  ...
  },
  {
    ...
    a: "Pagas con tu tarjeta a través de MercadoPago, así queda registro de la compra y tienes 7 días para reclamar si algo sale mal. Eliges retiro en mano gratis con el vendedor o despacho por courier a todo Chile.",
  },
  {
        ...
        <main className="max-w-6xl mx-auto px-6 py-10">
          ...
          <section className="mt-8 mb-12 max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <ButtonLink href="/search?q=historia%20de%20chile" className="shadow-sm">
                Ver disponibles
              </ButtonLink>

      ...
      <Link href={`/listings/${listing.id}`} className="block">
        <div className="relative aspect-[3/4] bg-cream-warm flex items-center justify-center overflow-hidden">
          {book.cover_url ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-cream-warm to-cream flex flex-col items-center justify-center gap-2">
              <svg className="w-10 h-10 text-ink/20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>

        ...
        <div className="flex-1 overflow-x-auto scrollbar-hide snap-x snap-mandatory">
          <div className="flex gap-3 min-w-max pr-6">
            ...
            <button
              ...
              className="flex-shrink-0 w-44 bg-white border border-cream-dark shadow-sm p-4 hover:border-brand-500 hover:shadow-md transition-all text-left snap-start rounded-lg"
            >
            ...
            <a
              href="#como-publicar"
              className="flex-shrink-0 w-44 bg-white border border-cream-dark shadow-sm p-4 hover:border-brand-500 hover:shadow-md transition-all snap-start rounded-lg"
            >
              <svg className="w-5 h-5 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <a
              href="#arriendos"
              className="flex-shrink-0 w-44 bg-brand-50 border border-brand-200 shadow-sm p-4 hover:border-brand-500 hover:shadow-md transition-all snap-start rounded-lg"
            >
              <svg className="w-5 h-5 text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
